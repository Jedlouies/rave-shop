        ...
        <div className="no-login-catalog-container">
            <div className="catalog-actions">
                ...
                <div className="right-icons">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16" onClick={handleCart}>
                ...
                <div className="grid">
                    {filteredShoes.length === 0 ? (
                        <div className="no-products-found">
                            <img src="/no-data.gif" alt="no-results" width={150}/>
