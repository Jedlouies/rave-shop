  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, (user) => {
      ...
      if (user) {
        ...
        setUserProfile(user.photoURL || defaultProfile);
      } else {
        setUserName("Guest");
    ...
    <nav className="nav-bar-container">
      ...
      {isLoggedIn ? (
        <div className="nav-links">
          <div className="nav-link-item" onClick={handleProductClicked}>
          ...
          <div className="user-profile" onClick={handleProfileClicked}>
              <img src={userProfile} alt="user" />
          </div>

          {showMenu && <Menu onClose={() => setShowMenu(false)} />}

          <div className="nav-link-item" onClick={handleLogoutClicked}>
